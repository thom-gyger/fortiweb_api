...
class UserTrackingRuleConditionItem(EndpointBase):
    id: Optional[int] = field(metadata=EndpointBase.post_mark_optional | EndpointBase.key_mark)
    authentication_result_type: str = field(metadata=EndpointBase.post_mark)
    HTTP_match_target: str = field(metadata=EndpointBase.post_mark)
