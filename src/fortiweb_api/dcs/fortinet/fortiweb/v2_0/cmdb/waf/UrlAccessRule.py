...
class UrlAccessRule(EndpointBase):
    from .UrlAccessRuleMatchConditionItem import UrlAccessRuleMatchConditionItem
    q_ref: Optional[int]
    ...
    match_condition: List[UrlAccessRuleMatchConditionItem] = field(default_factory=list)
