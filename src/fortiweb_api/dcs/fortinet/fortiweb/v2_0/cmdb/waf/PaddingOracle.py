...
class PaddingOracle(EndpointBase):
    from .PaddingOracleUrlItem import PaddingOracleUrlItem
    q_ref: Optional[int]
    ...
    flag: int
    sz_protected_url_list: int

    protected_url_list: List[PaddingOracleUrlItem] = field(default_factory=list)
