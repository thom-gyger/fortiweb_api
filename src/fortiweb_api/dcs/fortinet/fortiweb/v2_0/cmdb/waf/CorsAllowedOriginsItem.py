...
class CorsAllowedOriginsItem(EndpointBase):
    ...
    origin_name: str = field(metadata=EndpointBase.post_mark)
    port: int = field(metadata=EndpointBase.post_mark)
    include_sub_domains: str = field(metadata=EndpointBase.post_mark)
