...
class LinkCloakingRule(EndpointBase):
    from .LinkCloakingRuleExceptionItem import LinkCloakingRuleExceptionItem
    q_ref: Optional[int]
    ...
    url_pattern: str = field(metadata=EndpointBase.post_mark)
    sz_exceptions: int

    exceptions: List[LinkCloakingRuleExceptionItem] = field(default_factory=list)
