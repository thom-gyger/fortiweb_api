...
class OpenApiPolicy(EndpointBase):
    from .OpenApiPolicyFileItem import OpenApiPolicyFileItem
    q_ref: Optional[int]
    ...
    schema_file: List[OpenApiPolicyFileItem] = field(default_factory=list)
