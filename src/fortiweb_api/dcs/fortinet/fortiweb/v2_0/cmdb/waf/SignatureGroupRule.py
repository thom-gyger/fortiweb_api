...
class SignatureGroupRule(EndpointBase):
    from .SignatureGroupRuleCondition import SignatureGroupRuleCondition
    q_ref: Optional[int]
    ...
    sz_meet_condition: int

    meet_condition: List[SignatureGroupRuleCondition] = field(default_factory=list)
