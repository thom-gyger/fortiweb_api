...
class MobileApiProtectionRule(EndpointBase):
    from .MobileApiProtectionRuleUrlItem import MobileApiProtectionRuleUrlItem
    q_ref: Optional[int]
    ...
    url_list: List[MobileApiProtectionRuleUrlItem] = field(default_factory=list)
